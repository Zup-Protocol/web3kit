...
mixin _$SmartContractAbiSignatureDto {
  ...
  List<SmartContractAbiSignatureDto> get components =>
...
abstract class $SmartContractAbiSignatureDtoCopyWith<$Res> {
  ...
  $Res call(
      ...
      String type,
      String internalType,
      List<SmartContractAbiSignatureDto> components});
}
...
class _$SmartContractAbiSignatureDtoImpl
  ...
  _$SmartContractAbiSignatureDtoImpl(
      ...
      required this.type,
      this.internalType = "",
      final List<SmartContractAbiSignatureDto> components =
  ...
  final List<SmartContractAbiSignatureDto> _components;
  @override
  @JsonKey()
  List<SmartContractAbiSignatureDto> get components {
  ...
  @override
  String toString() {
    return 'SmartContractAbiSignatureDto(name: $name, type: $type, internalType: $internalType, components: $components)';
  }

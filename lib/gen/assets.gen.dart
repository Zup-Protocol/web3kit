...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [cableConnectorHorizontal, cableConnectorSlash, infoCircle, magnifyingglass, squareOnSquare, walletBifold, walletSearch, walletConnect];
}
